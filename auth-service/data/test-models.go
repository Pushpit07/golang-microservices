...
func (*PostgresTestRepository) DeleteById(id int) error {
	panic("unimplemented")
}

// PasswordMatcches implements Repository.
func (*PostgresTestRepository) PasswordMatcches(plainText string, user User) (bool, error) {
	panic("unimplemented")
}
